...
const Header = ( ) =>{
  ...
  return (
    ...
    <div className={`bg-black p-6 md:p-0 md:bg-none  w-full md:w-auto   md:mr-24 md:h-12 h-48  mt-5 flex  md:flex-row flex-col transition-all ease-in duration-500 md:opacity-100  ${open ? 'opacity-100':'top-[-1000px] opacity-0'}  `}>
